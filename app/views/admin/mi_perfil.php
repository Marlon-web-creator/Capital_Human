...
<head>
    ...
    <link rel="stylesheet" href="/Capital_HumanMVC/public/css/admin/Perfil.css">
</head>
    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="<?php echo ($usuario_rol === 'admin') ? 'admin_dashboard.php' : 'empleado_dashboard.php'; ?>">
                        <i class="bi bi-grid-1x2-fill"></i> Dashboard
                    </a>
                </li>
                <li class="active">
                    <a href="updated_profile_session.php"><i class="bi bi-person-fill"></i> Mi perfil</a>
                </li>
            ...
            <div class="topbar">
                ...
                <div class="topbar-right" style="display: flex; align-items: center; gap: 15px;">
                    <div class="user-profile">
                        <img src="<?php echo obtenerFotoPerfil($empleado['foto_perfil']); ?>?v=<?php echo time(); ?>" alt="Usuario Avatar" style=" cursor: pointer; width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
                        <div class="user-info">
                            ...
                            <span class="user-role">
                                ...
                                if ($usuario_rol === 'admin') {
                                    ...
                                    echo htmlspecialchars($empleado['departamento_nombre'] ?? 'Sin departamento');
                                }
                                ?>
                            </span>
                        </div>
                    ...
                    <div class="profile-header">
                        <div class="profile-header-left">
                            <div class="profile-avatar">
                                <img src="<?php echo obtenerFotoPerfil($empleado['foto_perfil']); ?>?v=<?php echo time(); ?>" class="avatar-large" style="object-fit: cover;">
                            ...
                            <div class="profile-details">
                                ...
                                <p class="profile-role">
                                    ...
                                    if ($usuario_rol === 'admin') {
                                        ...
                                        echo htmlspecialchars($empleado['cargo'] ?? 'Sin cargo especificado');
                                    }
                                    ?>
                                </p>
            ...
            <form method="POST" action="">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="nombre_completo" name="nombre_completo" value="<?php echo htmlspecialchars($empleado['nombre_completo']); ?>" required>
                    </div>
                    <?php if ($usuario_rol !== 'admin'): ?>
                        <div class="form-group">
                            <label for="fecha_nacimiento">Fecha de Nacimiento:</label>
                            <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" value="<?php echo $empleado['fecha_nacimiento']; ?>">
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($usuario_rol !== 'admin'): ?>
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="documento_identidad" name="documento_identidad" value="<?php echo htmlspecialchars($empleado['documento_identidad']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nacionalidad" name="nacionalidad" value="<?php echo htmlspecialchars($empleado['nacionalidad']); ?>">
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if ($usuario_rol !== 'admin'): ?>
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="telefono_fijo" name="telefono_fijo" value="<?php echo htmlspecialchars($empleado['telefono_fijo']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="ciudad" name="ciudad" value="<?php echo htmlspecialchars($empleado['ciudad']); ?>">
                        </div>
                        <div class="form-group">
                            <label for="codigo_postal">Código Postal:</label>
                            <input type="text" id="codigo_postal" name="codigo_postal" value="<?php echo htmlspecialchars($empleado['codigo_postal']); ?>">
                        </div>
                    </div>
                <?php endif; ?>
